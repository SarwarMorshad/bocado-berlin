              ...
              <div className="text-white">
                ...
                <div className="space-y-4 text-gray-200 leading-relaxed text-lg">
                  <p>
                    ...
                    <span className="text-primary"> Main Uddin</span>, sind wir schnell zu einem beliebten
                    Ziel für Einheimische und Besucher geworden, die echte spanische Küche genießen möchten.
                  </p>
                  <p>
                    Unser Name „BOCADO“ bedeutet auf Spanisch „ein Bissen“ oder „eine Kostprobe“ und spiegelt
                    perfekt unsere Philosophie wider: Wir servieren exquisite kleine Gerichte, die das Wesen
                    der spanischen kulinarischen Tradition einfangen. Jede Tapas-Spezialität wird mit Sorgfalt
                  ...
                  <p>
                    ...
                    einladenden Ort geschaffen, an dem Freunde und Familien zusammenkommen können, um
                    köstliches Essen, guten Wein und unvergessliche Momente zu teilen. Unsere Leidenschaft ist
                    es, jedem Gast das Gefühl zu geben, in eine gemütliche Tapasbar im Herzen von Madrid oder
                    Barcelona eingetaucht zu sein.
                  </p>
                  <p>
        ...
        <section className="py-16 bg-[#0f3a36]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-center text-gray-200 text-lg mb-12 max-w-3xl mx-auto">
              Bei BOCADO setzen wir uns dafür ein, ein authentisches spanisches Esserlebnis zu bieten, das
              über großartiges Essen hinausgeht.
            </p>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center text-white">
              ...
              <div className="space-y-6 text-gray-200 text-lg leading-relaxed">
                ...
                <p>
                  Wir sind leidenschaftlich darum bemüht, die Authentizität der spanischen Küche zu bewahren
                  und gleichzeitig eine einladende Atmosphäre für alle zu schaffen. Ob Sie ein langjähriger
