  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Reservieren Sie Ihren Tisch bei BOCADO Berlin online. Wählen Sie Datum, Uhrzeit und Anzahl der Gäste für ein unvergessliches kulinarisches Erlebnis."
        />
      </Helmet>
                ...
                <form onSubmit={handleSubmit} className="space-y-6" ref={formRef}>
                  ...
                  <div className="bg-[#fbbf24]/20 border-l-4 border-[#fbbf24] p-4 rounded">
                    <p className="text-white text-sm">
                      <strong>🎉 Große Gruppe oder ganzes Restaurant buchen?</strong> Für Reservierungen über
                      30 Personen oder um das gesamte Restaurant für eine private Veranstaltung zu buchen,
                  ...
                  <div className="bg-[#feaa3f]/20 border-l-4 border-[#feaa3f] p-4 rounded">
                    <p className="text-white text-sm">
                      <strong>📞 Erinnerung:</strong> Wir können Sie vor Ihrem Reservierungstag anrufen, um
                      Sie daran zu erinnern. Bitte stellen Sie sicher, dass Ihre Telefonnummer korrekt ist.
                    </p>
                  </div>
